...
class ConnectorsViewController < NSViewController
    ...
    def awakeFromNib
        ...
        self.connectors_list.selectRowIndexes NSIndexSet.indexSetWithIndex(0), byExtendingSelection:true
        self.suffix.stringValue = ".#{App.global.token_model.suffix}"
        self.new_suffix.stringValue = ".#{App.global.token_model.suffix}"
    end
    
    def title
        NSLocalizedString("Tunnels")
    end
