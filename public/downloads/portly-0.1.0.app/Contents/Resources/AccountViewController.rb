...
class AccountViewController < NSViewController
    ...
    def awakeFromNib
        self.allow_remote.state = App.global.token_model.allow_remote || false
        @launchController ||= LaunchAtLoginController.alloc.init
        self.start_on_login.state = @launchController.launchAtLogin
        self.connected_as.stringValue = "You are connected as #{NSHost.currentHost.localizedName}."
    end
